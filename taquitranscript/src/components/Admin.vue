<template>
            ...
            >
              ...
              >
                ...
                <v-card>
                  <br>
                  <v-card-title>
                    <span class="text-h5 mx-auto">Agregar una cocina</span>
                  </v-card-title>
    ...
    export default{    
        ...
        methods:{
            addTask(){ 
                axios.post(this.postURL + '/task/add_kitchen', this.newTask2, this.config_request)
                    .then(res => {                                         
            ...
            deleteTask(task){                      
                axios.post(this.postURL + '/task/delete_kitchen', {CUI: task.ID_Cocina}, this.config_request)
                    .then((res) => {                      
        ...
        created(){ 
            axios.post(this.postURL + '/task/get_kitchens')
